...
export default function ProjectInfo() {
    ...
    return (
        <div className="px-10 flex flex-col my-6">
            ...
            <div>
                <h2 className="text-3xl mb-4 text-teal-400 font-medium underline underline-offset-8 mt-4">
                    The Brew Box
                </h2>
            ...
            <div>
                <h2 className="text-xl mb-4 text-teal-400 underline underline-offset-8 mt-6">
                    Overview
                </h2>
                <p className="text-gray-100 text-sm leading-5 mb-4">
            ...
            <div>
                ...
                <ul className="list-disc ml-6 text-gray-100 text-sm">
            ...
            <div>
                ...
                <p className="text-gray-100 text-sm mt-2 leading-5">
