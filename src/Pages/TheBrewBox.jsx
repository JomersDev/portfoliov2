    ...
    return (
        <div className="flex flex-col my-6 max-w-3xl mx-auto px-10">
            ...
            <div>
                ...
                <p className="text-gray-100 text-sm leading-5 mb-4 md:text-base">
            ...
            <div>
                ...
                <ul className="list-disc ml-6 text-gray-100 text-sm md:text-base">
            ...
            <div>
                ...
                <p className="text-gray-100 text-sm leading-5 md:text-base">
                ...
                <p className="text-gray-100 text-sm mt-2 leading-5 md:text-base">
