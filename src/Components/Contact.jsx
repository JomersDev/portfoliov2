...
export default function() {
    ...
    return (
        <section id='contact' className="mb-28 px-10 md:px-16 flex flex-col items-center">
            ...
            <div className="bg-gray-100 py-8 px-6 shadow-lg rounded-lg w-[90%] md:max-w-5xl md:flex md:gap-x-12">
                ...
                <div className="text-black text-center w-full hidden md:flex md:flex-col justify-between">
                    <p className="pt-6">
